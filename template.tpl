    ...
    "subParams": [
      {
        "type": "LABEL",
        "name": "contactInfo",
        "displayName": "You can populate the fields below with additional information about your users. If you leave a field blank or if you choose a variable that returns an \u003ccode\u003eundefined\u003c/code\u003e or \u003ccode\u003enull\u003c/code\u003e value, the parameter will be omitted from the outgoing hit to Tracklution. \u003cstrong\u003eThe tracking script automatically hashes all information before it is dispatched to Tracklution servers\u003c/strong\u003e. \u003ca href\u003d\"https://docs.tracklution.com/tracking-events/tracking-events#contactinfo-event-1\"\u003eRead more here\u003c/a\u003e.\u003cbr/\u003e\u003cbr/\u003e"
      },
      {
        "type": "TEXT",
        "name": "email",
